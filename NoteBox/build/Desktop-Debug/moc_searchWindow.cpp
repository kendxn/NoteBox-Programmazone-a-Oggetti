...
#include "../../../../form local/PaO/Notebox/searchWindow.h"
...
template <> constexpr inline auto searchWindow::qt_create_metaobjectdata<qt_meta_tag_ZN12searchWindowE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'on_buttonAnnullaRicerca_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_lineSearch_textChanged'
        ...
        // Slot 'on_buttonCancella_clicked'
...
void searchWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_buttonAnnullaRicerca_clicked(); break;
        case 1: _t->on_lineSearch_textChanged((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->keyPressEvent((*reinterpret_cast<std::add_pointer_t<QKeyEvent*>>(_a[1]))); break;
        case 3: _t->on_buttonCancella_clicked(); break;
        default: ;
        }
    }
}
