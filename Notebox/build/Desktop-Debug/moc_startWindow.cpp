...
template <> constexpr inline auto startWindow::qt_create_metaobjectdata<qt_meta_tag_ZN11startWindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "",
        "importaPremuto",
        "on_buttonInizia_clicked",
        "on_buttonImporta_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Signal 'iniziaPremuto'
        QtMocHelpers::SignalData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'importaPremuto'
        QtMocHelpers::SignalData<void()>(3, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'on_buttonInizia_clicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_buttonImporta_clicked'
...
void startWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->iniziaPremuto(); break;
        case 1: _t->importaPremuto(); break;
        case 2: _t->on_buttonInizia_clicked(); break;
        case 3: _t->on_buttonImporta_clicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (startWindow::*)()>(_a, &startWindow::iniziaPremuto, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (startWindow::*)()>(_a, &startWindow::importaPremuto, 1))
            return;
    }
}
...
// SIGNAL 0
void startWindow::iniziaPremuto()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void startWindow::importaPremuto()
{
